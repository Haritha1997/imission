...
<body id="imagediv">
			...
			<td width="35%" style="vertical-align:top">
			 ...
			 <tr>
				 <td style="min-width:300px;vertical-align:top;">
					...
					<div style="max-width:400px;min-width:312px;padding-top:5px;">
					    <img src="/imission/images/nomus_logo.jpg" alt="nomuslogo" width="320px" height="80px"/>
					   </div>
					</div>
				 </td>
				</tr>
    ...
    onfocus="this.removeAttribute('readonly');">
				...
				<tr>
					<td style="" id="imgtd"> -->
					  <div style="width:100%;height: 100%" style="margin : 0">
					  <div style="max-width:400px;min-width:312px;padding-top:5px;margin-left: 5px">
					    <img src="/imission/images/nomus_logo.jpg" alt="nomuslogo" width="320px" height="80px"/>
					   </div>
						<div class="imgtext" style="max-width:400px;min-width:312px;">
							...
							<img src="/imission/images/imission_logo.png" alt="imissionlogo" width="320px" height="10px"/>
						</div>
						<div class="imglogin">
						<div class="form-group"  style="display:inline;">
							<!--<label for="input_j_username" class="col-sm-1 control-label">Username</label>-->							
    ...
    onfocus="this.removeAttribute('readonly');">
						...
						<a href="forgotpwd.jsp" style="font-size:13px;margin-left:40%;margin-top:50%;color:white">Forgot Password</a><br/>
						<div class="form-group" style="display:inline" align="center">
							<label for="submit" class="col-sm-1 control-label"></label><br/>
							<input type="submit" value="Login" name="Login" id="login" class="btn btn-default"></input>
						</div>
