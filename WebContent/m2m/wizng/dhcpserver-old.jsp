...
<script type = "text/javascript">
	var txtBox1 = new Array("poolname", "dsnwip", "dsmask", "dsgw", "excludestartip", "excludeendip", "dsprimdns");
    var txtBox2 = new Array("Pool Name", "Network IP", "SubnetMask", "Gateway", "Exclude Start IP", "Exclude End IP", "Primary DNS");
      ...
      <table id="WiZConf" align="center">
         <tbody>
            ...
            <tr>
               <td>Pool Name</td>
               <td><%=poolname%></td>
               <td width="120px"><input type="text" class="text" id="poolname" maxlength="36" name="poolname" onkeypress="return NameKeyOnly(event)" value="<%=poolname%>"></td>
            </tr>
            <tr>
               <td>Network IP Address</td>
               <td><%=networkip%></td>
               <td width="120px"><input type="text" value="<%=networkip%>" class="text" size="12" maxlength="15" id="dsnwip" name="dsnwip" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Subnet Mask Address</td>
               <td><%=subnet%></td>
               <td width="120px"><input type="text" value="<%=subnet%>" class="text" size="12" maxlength="15" id="dsmask" name="dsmask" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Default Gateway</td>
               <td><%=defaultgw%></td>
               <td width="120px"><input type="text" value="<%=defaultgw%>" class="text" size="12" maxlength="15" id="dsgw" name="dsgw" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Exclude Start IP Range</td>
               <td><%=esiprange%></td>
               <td width="120px"><input type="text" value="<%=esiprange%>" class="text" size="12" maxlength="15" id="excludestartip" name="excludestartip" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Exclude End IP Range</td>
               <td><%=eeiprange%></td>
               <td width="120px"><input type="text" value="<%=eeiprange%>" class="text" size="12" maxlength="15" id="excludeendip" name="excludeendip" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Domain Name</td>
               <td><%=domainnme%></td>
               <td width="120px"><input name="dsdomain" value="<%=eeiprange%>" id="dsdomain" maxlength="36" class="text" onkeypress="return NameKeyOnly(event)" type="text"></td>
            </tr>
            <tr>
               <td>Primary DNS</td>
               <td><%=primdns%></td>
               <td width="120px"><input type="text" value="<%=primdns%>" class="text" size="12" maxlength="15" id="dsprimdns" name="dsprimdns" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Secondary DNS</td>
               <td><%=secdns%></td>
               <td width="120px"><input type="text" value="<%=secdns%>" class="text" size="12" maxlength="15" id="dssecdns" name="dssecdns" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
         </tbody>
      </table>
