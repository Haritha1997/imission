...
function showsubmenu(menuname)
{
	var submen2arr = ["ethernetmenu","firewalmenu","servpnmenu","managementmenu",
				   "stavpnmenu","debugmenu","nwstatmenu", "systemmenu","dhcpmenu", "configmenu"];
	...
	<div style="position:relative;padding-bottom:1%;"> <!-- New compact -->
		...
		<div>
			...
			<ul class="submenu1" id="sysmenu">
				...
				<li onclick="hilightthis(this,'submenu1')"><a href="/cgi/Nomus.cgi?cgi=Startup.cgi" target="displayframe" onclick="showsubmenu('empty')">Startup</a></li>
				<li onclick="hilightthis(this,'submenu1')"><a href="/cgi/Nomus.cgi?cgi=Software.cgi" target="displayframe" onclick="showsubmenu('empty')">Software</a></li>
			</ul>
			<!-- System menu end-->
			<!-- status menu start-->
			...
			<!--	<li onclick="hilightthis(this,'submenu1')"><a href="#" onclick="showsubmenu('empty')">Firewall</a></li>
				...
				<li onclick="hilightthis(this,'submenu1')"><a href="/cgi/Nomus.cgi?cgi=Processes.cgi" target="displayframe" onclick="showsubmenu('empty')">Processes</a></li>
		...
		<div>
			...
			<ul class="submenu2" id="configmenu">
				<li onclick="hilightthis(this,'submenu2')"><a href="/cgi/Nomus.cgi?cgi=FactorySetting.cgi" target="displayframe">Factory Settings</a></li>
