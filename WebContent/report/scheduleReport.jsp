...
<jsp:include page="/bootstrap.jsp" flush="false">
	...
	<jsp:param name="breadcrumb"
		value="<a href='report/database/reportList.htm'>List Reports</a>" />
...
function exportReport()
{
	...
	form.action = "runreport?reportid="+reportid;
	form.submit();
...
<form method="post" id="reportform"
	action="report/onlineReport.jsp?reportId=<%=reportId%>">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
					...
					<div class="form-group">
						...
						<div class="col-md-1">
							<select name="format" class="select">
								...
								<option value="EXCEL" <%if(format.equals("EXCEL")){%> selected
									<%}%>>EXCEL</option>
							</select>
						</div>
					</div>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-1">
							<select id="nodesel" name="nodesel" class="select"
								onchange="showOrHideInput('nodesel')">
						...
						<div class="col-md-4" style="display: inline">
							<select id="choose" name="choose" class="select"
								style="display: none; margin-right: 4%; min-width: 110px">
								<option value="slnumber">Serial Number</option>
								<option value="loopbackip" <%if(choose.equals("loopbackip")){%>
									selected <%}%>>Loopback IP</option>
							</select> <input type="text" id="chooseinput" name="chooseinput"
								value="<%=chooseinput%>" style="display: none"></input>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-1" style="display: inline">
							<input type="text" id="chooseinput" name="chooseinput"
								style="width: 120px" value="<%=chooseinput%>"></input>
						</div>
					</div>
					<%} %>
				</div>
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-1">
							<select id="timeperiod" name="timeperiod" class="select"
								onchange="showOrHideInput('timeperiod')">
								<option value="today">Today</option>
								<option value="yesterday"
									<%if(timeperiod.equals("yesterday")){%> selected <%}%>>Yesterday</option>
								<option value="lastweek" <%if(timeperiod.equals("lastweek")){%>
									selected <%}%>>Last Week</option>
						...
						<div class="col-md-5" id="daterangeid" style="display: none">
							<label style="min-width: 110px; margin-right: 3%"> Date
								Range : </label> <input type="text" value="<%=fromdate%>"
								class="datepicker" id="fromdate" name="fromdate" class="select"
								style="margin-right: 4%;"></input> <input type="text"
								value="<%=todate%>" class="datepicker" id="todate" name="todate"></input>
						</div>
					</div>
				</div>
				<% }%>
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="col-md-8">
							<%if(reportId.equals("local_Device-Uptime")){%>
							<input type="submit" class="btn btn-default" value="Run Report"
								id="run" />
							<%}%><label class="btn btn-default" onclick="exportReport()">Schedule
								Report</label>
						</div>
					</div>
				</div>
		  ...
		  {%>
							<th><div align="center" valign="middle"
									onclick="setorderby('nodelabel','<%=orderby%>','<%=ordertype%>')">
									Node Name</div></th>
							<th><div align="center" valign="middle"
									onclick="setorderby('loopbackip','<%=orderby%>','<%=ordertype%>')">
									IP Address</div></th>
							<th><div align="center" valign="middle"
		...
		{    
			...
			%>
						...
						<tr>
							<td align="center"><%=rs.getString("nodelabel")==null?"":rs.getString("nodelabel")%>
							</td>
							<td align="center"><%=rs.getString("loopbackip")==null?"":rs.getString("loopbackip")%>
							</td>
							<td align="center"><%=rs.getString("slnumber")==null?"":rs.getString("slnumber")%>
							</td>
							<td align="center"><%=rs.getString("fwversion")==null?"":rs.getString("fwversion")%>
							</td>
							<td align="center"><%=rs.getString("location")==null?"":rs.getString("location")%>
							</td>
							<td align="center"><%=rs.getString("modulename")==null?"":rs.getString("modulename")%>
							</td>
							<td align="center"><%=rs.getString("revision")==null?"":rs.getString("revision")%>
							</td>
							<td align="center"><%=rs.getString("createdtime")==null?"":rs.getString("createdtime")%>
							</td>
							<td align="center"><%=rs.getString("status")==null?"":rs.getString("status")%>
							</td>
						</tr>
						<%}
			}
			...
			%>
						<tr>
							<td align="center" width="14%"><%=rs.getString("nodelabel")==null?"":rs.getString("nodelabel")%>
							</td>
							<td align="center" width="14%"><%=rs.getString("loopbackip")==null?"":rs.getString("loopbackip")%>
							</td>
							<td align="center" width="14%"><%=rs.getString("slnumber")==null?"":rs.getString("slnumber")%>
							</td>
							...
							<td align="center" width="14%"><%=down_dur%></td>
							<td align="center" width="14%">
								<div id="lightgerydiv">
							...
							<td align="center" width="14%"><%=up_dur%></td>
						</tr>
						<%}
			}
			}catch(Exception e)
