...
<html>
   ...
   <body>
      <form name="f1" action="savepage.jsp?page=deleteuser&slnumber=<%=slnumber%>" method="post" onsubmit="return validatePwd()">
         <p class="style1" align="center">Delete User Configuration</p>
