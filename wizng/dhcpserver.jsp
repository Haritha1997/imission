   ...
   if(slnumber != null && slnumber.trim().length() > 0)
   {
	   ...
	   try
	   {
   		...
   		if(dhcpobj != null)
			...
			if(activation.equals("No Change"))
			{
				activation="";
			}
...
function chkFunc() {
	...
	var defaultgw=document.getElementById("dsgw");
	...
	for (var x = 0; x < txtBox1.length; x++) {
		...
		if ((txtBox1[x] == "dsnwip") || (txtBox1[x] == "dsgw") || (txtBox1[x] == "excludestartip") || (txtBox1[x] == "excludeendip") || (txtBox1[x] == "dsprimdns") || (txtBox1[x] == "dssecdns")) {
			...
			if (poolobj.value.trim() == "") {
				...
				poolobj.title = "Pool Name should not be empty"; 
				valid = false;
			} else {
				valid = true;
		...
		if (!valid) {
			if (ip4add == "") {
				if ((x == 0) || (x == 1) || (x == 2) || (x == 3)  || (x == 6) || (x == 7))  altmsg += txtBox2[x] + " should not be empty.\n";
...
function validateIP(id, checkempty, name) {
	...
	if (id == "dsnwip" || id=="dsgw" || id=="dsprimdns" || id=="dssecdns") {
      ...
      <table id="WiZConf" align="center">
         <tbody>
            ...
            <tr>
               <td>Pool Name</td>
               <td><%=poolname%></td>
               <td width="120px"><input type="text" class="text" id="poolname" maxlength="36" name="poolname" value="<%=poolname%>" onkeypress="return NameKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Network IP Address</td>
               <td><%=networkip%></td>
               <td width="120px"><input type="text"  class="text" size="12" maxlength="15" id="dsnwip" name="dsnwip" value="<%=networkip%>" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Subnet Mask Address</td>
               <td><%=subnet%></td>
               <td width="120px"><input type="text"  class="text"  size="12" maxlength="15" id="dsmask" name="dsmask" value="<%=subnet%>" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Default Gateway</td>
               <td><%=defaultgw%></td>
               <td width="120px"><input type="text"  class="text" size="12" maxlength="15" id="dsgw" name="dsgw"  value="<%=defaultgw%>" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Exclude Start IP Range</td>
               <td><%=esiprange%></td>
               <td width="120px"><input type="text"  class="text" size="12" maxlength="15" id="excludestartip" value="<%=esiprange.equals("0.0.0.0")?"":esiprange%>" name="excludestartip" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Exclude End IP Range</td>
               <td><%=eeiprange%></td>
               <td width="120px"><input type="text"  class="text" size="12" maxlength="15" id="excludeendip" value="<%=eeiprange.equals("0.0.0.0")?"":eeiprange%>" name="excludeendip" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Domain Name</td>
               <td><%=domainnme%></td>
               <td width="120px"><input name="dsdomain"  id="dsdomain" maxlength="36" class="text" value="<%=domainnme%>" onkeypress="return NameKeyOnly(event)" type="text"></td>
            </tr>
            <tr>
               <td>Primary DNS</td>
               <td><%=primdns%></td>
               <td width="120px"><input type="text"  class="text" size="12" maxlength="15" id="dsprimdns" value="<%=primdns%>" name="dsprimdns" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
            <tr>
               <td>Secondary DNS</td>
               <td><%=secdns%></td>
               <td width="120px"><input type="text" class="text" size="12"  maxlength="15" id="dssecdns" value="<%=secdns%>" name="dssecdns" onkeypress="return IPv4AddressKeyOnly(event)"></td>
            </tr>
         </tbody>
      </table>
